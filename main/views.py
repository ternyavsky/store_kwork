            ...
            try:
                ...
                if question:
                    messages.error(request,
                                   'Вы уже оставили обращение! Дождитесь ответа на текущее обращение чтобы создать следующее.')
                    print('work try')
...
def single_buy(request, product_id):
    ...
    quickpay = Quickpay(
        # 410014797761818 - ME
        # 410011820942473 - ALENA
        receiver="410011820942473В",
        quickpay_form="shop",
        targets="Оплата товара",
        paymentType="SB",
        sum=total)
    # https://yoomoney.ru/to/410014797761818
    return redirect(quickpay.redirected_url)
